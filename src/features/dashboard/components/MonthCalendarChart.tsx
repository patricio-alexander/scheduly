...
const LEGEND = [
  { key: "appointments", label: "Turnos / servicios", color: LINE_COLORS.appointments },
          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted">
                Turnos, productos, ingresos y gastos por día · clic para detalle
              </p>
            </div>
          </div>
        ...
        {data ? (
          <div className="mb-4 grid grid-cols-2 gap-2 md:grid-cols-4">
            <div className="rounded-xl border border-separator bg-surface-secondary/25 px-3 py-2">
              <p className="text-[11px] text-muted">Turnos / servicios</p>
              <p

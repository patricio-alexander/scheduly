...
export default function TasksPage() {
  ...
  const handleSubmit = useCallback(
    ...
    [editing, create, update, closeModal, isAdmin, user?.id],
  );
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
      <PageHeader
        ...
        action={
          isAdmin ? (
            <div data-onboarding="tasks-create">
              <Button onPress={() => openCreate("todo")}>
      ...
      <div data-onboarding="tasks-kanban">
        <TaskKanban
          tasks={tasks}
          loading={loading}
            ...
            <Modal.Dialog>
              ...
              <Modal.Body>
                <TaskForm
                  ...
                  assignees={isAdmin ? assignees : [{ id: user.id, name: user.name }]}

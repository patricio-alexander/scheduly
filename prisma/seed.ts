    ...
    subscription: {
      ...
      modules: [
        ...
        },
        {
          ...
          end_trial: null,
          sections: [
            section(1, "/produccion/insumos", "Insumos y marcas", "planned"),
            section(2, "/produccion/recetas", "Recetas", "planned"),
            section(3, "/produccion/fabricacion", "Producción", "planned"),
          ],
        },
        {
          id: 11,
        ...
        },
        {
          ...
          sections: [
            ...
            section(2, "/sistema/planes", "Planes"),
            section(3, "/sistema/modulos", "Módulos"),
            section(4, "/sistema/configuracion?tab=backups", "Backups JSON"),
            section(5, "/sistema/perfil", "Perfil"),
            section(6, "/sistema/donaciones", "Donaciones", "planned"),
          ],
        },
      ],
    },

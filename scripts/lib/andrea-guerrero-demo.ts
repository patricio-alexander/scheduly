...
/** Programador · cuenta técnica compartida (mantenimiento) */
export const AG_PROGRAMMER = {
  username: "administrador",
  password: AG_PASSWORD,
  firstName: "Mantenimiento",
  firstLastName: "Técnico",
...
/** Equipo · rol Empleado (4 por local · usernames alineados al seed/simulador) */
